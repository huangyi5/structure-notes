...
盈建科建模记得查看挠度（尤其是当结构跨度很大时，＞9m），若挠度超过限定值，则要在施工图（梁配筋图）相应梁的下面标注“起拱3/1000”----不知道为什么是3/1000？？
<img width="1337" height="410" alt="e90e6c51-6f81-41d4-a8ac-8de7cdb8f835" src="https://github.com/user-attachments/assets/927d54a4-4b43-49e1-aeeb-1e8894698cc2" />
...
**恒载**
- **外墙线荷载：2.6×（楼层高度-梁高）**
- **恒载1.5=0.05×20（水泥容重）+0.5**
- **厕所（有降板0.6m）的恒载=0.6×10+0.5=6.5**
1)   外墙采用铝模现浇混凝土墙体时，材料容重采用26kN/m3（梁上线荷载扣除梁高）；
2)   内外墙采用加气砼砌块砌筑，砌体容重8.0 KN/m3：
外墙时；200厚墙体：        8.0×0.2=1.6KN/㎡
内外面层（考虑贴面砖）： 1.0 KN/㎡
**∑**:   2.6 KN/㎡
内墙时：（a）100厚墙体：     8.0×0.10=0.80 KN/㎡
（b）200厚墙体：     8.0×0.20=1.6 KN/㎡
40厚双面抹灰：   20×0.04=0.8 KN/㎡
（a）∑: 1.60 KN/㎡
（b）∑: 2.40 KN/㎡
3)   门窗部分面荷载：按0.5 KN/m2 计算；
砌体线荷载 = {砌体面荷载×（墙长L×墙高H－洞口面积A）＋门窗面荷载×洞口面积A}/墙长L
注：墙高H应扣除梁高
4)   装配式ALC墙板线荷载：
ALC墙板容重按8.0 KN/m3 ：
（a）100厚墙体：     8.0×0.10=0.80 KN/㎡
（b）200厚墙体：     8.0×0.20=1.6 KN/㎡
面层荷载：每侧+0.10KN/㎡(卫生间、厨房除外)
厨房、卫生间、公共走廊、电梯前室墙体：每侧+0.40KN/㎡
5)   栏杆及栏板竖向线荷载：2.0kN/m（对于钢栏杆）和4.7kN/m（对于1.2m高120mm厚的混凝土栏板）；
6)   女儿墙按6.0kN/m（对于1.5m高150mm厚的混凝土女儿墙）；
7)    落地窗或推拉门统一用2kN/m ；
门窗、洞口等荷载荷载折减系数根据实际情况取值，可取0.7、0.8。

**面荷载：**
- 恒荷载=0.5(顶棚)+20×0.5（面层厚度）
屋面不上人0.5；露台3.5；卫生间=（降板300+50）×10+0.5(顶棚)=4
1) 普通住宅卧室、套内走廊、楼梯间楼面附加恒载取1.1kN/m2(面层50厚+0.1kN/m2顶棚);
2) 阳台、厨房、标准层电梯厅（合用前室）、公共走道楼面附加恒载取1.5kN/m2；
3) 首层、负一层、负二层及底板板面附加恒载取2.0kN/m2;
- 活荷载：查表(规范)
